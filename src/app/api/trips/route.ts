...
export async function GET() {
  try {
    ...
    const ownedQuery = supabase
      .from('trips')
      .select('id, title, destination, start_date, end_date, trip_length, status, group_type, group_size, cover_image, cover_image_meta, created_at, organizer_id, visited_cities')
