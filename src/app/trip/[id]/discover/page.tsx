      ...
      <div className="sticky top-0 z-20 bg-white border-b border-zinc-100">
        <div className="px-4 md:px-6 py-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:flex-nowrap sm:overflow-x-auto w-full sm:w-auto sm:flex-1 sm:min-w-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              {categories.map((cat) => (
                <button
                  key={cat.value}
